        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="md:w-1/2 text-center md:text-left">
            <div className="mb-8 md:mb-10 lg:mb-10">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-primary)] mb-4 px-4 md:px-0 lg:px-0">
                Hola, soy <span className="text-blue-600 dark:text-blue-40">Diego Extremiana</span>
              </h1>
              <h2 className="text-xl sm:text-2xl md:text-3xl text-[var(--text-secondary)] mb-6 px-4 md:px-0 lg:px-0">
          ...
          <div className="md:w-1/2 flex justify-center items-center px-4 md:px-0 lg:px-0">
            <div className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-[var(--border-primary)] shadow-lg relative">
              <img 
