...
return [
    ...
    'smtp_username' => '', // Tu dirección de correo (debe estar en variables de entorno)
    'smtp_password' => '',    // Contraseña de aplicación de Gmail (debe estar en variables de entorno)
    'smtp_port' => 587,                        // Puerto SMTP
    'smtp_secure' => 'tls',                    // Tipo de encriptación
    'from_email' => '', // Correo desde el que se envía (debe estar en variables de entorno)
    'from_name' => 'Formulario de Contacto Portfolio',   // Nombre que aparece como remitente
    'to_email' => ''  // Correo al que se envían los mensajes (debe estar en variables de entorno)
];